...
import com.wde.eventplanner.databinding.FragmentOrganizerProfileBinding;
...
public class ProfileFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        binding.updateButton.setOnClickListener(v -> updateOrganizer());
    ...
    private void updateOrganizer() {
        ...
        Profile request = new Profile(email, password, null, isNotificationMuted, null, name, surname, city, address, phone, null);
